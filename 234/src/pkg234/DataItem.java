    ...
    public static int countNodes(Node n) {
        ...
        if (n == null) {
            ...
            for (int i = 0; i < numItems + 1; i++) {
                Node nextNode = n.getChild(i);
                if (nextNode != null) {
                    total = total + countNodes(nextNode);
                }
...
class Tree234App {
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (true) {
            ...
            switch (choice) {
                case 'c':
                    int x = theTree.countNodes(theTree.getroot());

                    System.out.println("the number of nods = " + x);
                    break;

                case 'l':
                    int y = theTree.countleaf(theTree.getroot());
                    System.out.println("the number of the leaves is " + y);
                case 's':
                    theTree.displayTree();
                    break;
